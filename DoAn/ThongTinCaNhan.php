    ...
    <body>
        ...
        <main>
            ...
            <div style="margin-left:27vw;margin-top:20px">
                ...
                <table border="1px" style="background-color: whitesmoke;width: 700px;border-collapse: collapse;">

                    <form id="formquanlydanhmuc" action="SuaThongTin.php" method="post">
                        <tr>
                            <td>
                                <div>
                        ...
                        <tr>
                            <td colspan="2" style="text-align: center;"> <a href="SuaThongTin.php"><button type="button" class="btn btn-primary">Sửa thông tin</button></a></td>
                        </tr>
