    ...
    <main>
        ...
        <article> <!--Tìm Kiếm Sản Phẩm -->
            ...
            <div>
                ...
                <form method="post" action="AllDieuHoa.php?check=0">
                    <ul id="sptheogia">
        ...
        <aside style="height:auto;">
            ...
            $query = "SELECT * FROM sanpham, hinhanh,danhmuc WHERE danhmuc.MaDanhMuc=SanPham.MaDanhMuc AND sanpham.MaSanPham=hinhanh.MaSanPham AND sanpham.MaDanhMuc='DM4' limit $start_from, $per_page_record ;";
            ...
            if (isset($_POST['submitfil']) && !empty($_POST['check'])) {
                ...
                foreach ($_POST['check'] as $value) {
                    if ($value == 'check1') {
                        // $query = "SELECT * FROM sanpham, hinhanh,danhmuc WHERE danhmuc.MaDanhMuc=SanPham.MaDanhMuc AND sanpham.MaSanPham=hinhanh.MaSanPham AND sanpham.MaDanhMuc='DM4' AND sanpham.DonGia<=1000000";
                        $que1 = "INSERT INTO new (TenSanPham,HinhAnh,DonGia,MaSanPham) SELECT TenSanPham,HinhAnh,DonGia,sanpham.MaSanPham FROM sanpham, hinhanh,danhmuc WHERE danhmuc.MaDanhMuc=SanPham.MaDanhMuc AND sanpham.MaSanPham=hinhanh.MaSanPham AND sanpham.MaDanhMuc='DM4' AND sanpham.DonGia<=1000000";
                        // $result = $conn->query($query);
                        $rs1 = $conn->query($que1);
                    }
                    if ($value == 'check2') {
                        $que1 = "INSERT INTO new (TenSanPham,HinhAnh,DonGia,MaSanPham) SELECT TenSanPham,HinhAnh,DonGia,sanpham.MaSanPham FROM sanpham, hinhanh,danhmuc WHERE danhmuc.MaDanhMuc=SanPham.MaDanhMuc AND sanpham.MaSanPham=hinhanh.MaSanPham AND sanpham.MaDanhMuc='DM4' AND sanpham.DonGia>=1000000 AND sanpham.DonGia<=3000000";
                        $rs1 = $conn->query($que1);
                    }
                    if ($value == 'check3') {
                        $que1 = "INSERT INTO new (TenSanPham,HinhAnh,DonGia,MaSanPham) SELECT TenSanPham,HinhAnh,DonGia,sanpham.MaSanPham FROM sanpham, hinhanh,danhmuc WHERE danhmuc.MaDanhMuc=SanPham.MaDanhMuc AND sanpham.MaSanPham=hinhanh.MaSanPham AND sanpham.MaDanhMuc='DM4' AND sanpham.DonGia>=3000000 AND sanpham.DonGia<=5000000";
                        $rs1 = $conn->query($que1);
                    }
                    if ($value == 'check4') {
                        $que1 = "INSERT INTO new (TenSanPham,HinhAnh,DonGia,MaSanPham) SELECT TenSanPham,HinhAnh,DonGia,sanpham.MaSanPham FROM sanpham, hinhanh,danhmuc WHERE danhmuc.MaDanhMuc=SanPham.MaDanhMuc AND sanpham.MaSanPham=hinhanh.MaSanPham AND sanpham.MaDanhMuc='DM4' AND sanpham.DonGia<=10000000 AND sanpham.DonGia>5000000";
                        $rs1 = $conn->query($que1);
                    }
                    if ($value == 'check5') {
                        $que1 = "INSERT INTO new (TenSanPham,HinhAnh,DonGia,MaSanPham) SELECT TenSanPham,HinhAnh,DonGia,sanpham.MaSanPham FROM sanpham, hinhanh,danhmuc WHERE danhmuc.MaDanhMuc=SanPham.MaDanhMuc AND sanpham.MaSanPham=hinhanh.MaSanPham AND sanpham.MaDanhMuc='DM4' AND sanpham.DonGia>=10000000";
                        $rs1 = $conn->query($que1);
                    }
                }
            } ?>
            ...
            if (isset($_GET['check'])) {
                ...
                while ($dsn = $resultn->fetch_assoc()) {
                    ...
                    <div class="pagination">
                        ...
                        if ($page >= 2) {
                            echo "<a href='AllDieuHoa.php?check=0&page=" . ($page - 1) . "'>  Prev </a>";
                        }

                        for ($i = 1; $i <= $total_pages; $i++) {
                            if ($i == $page) {
                                $pagLink .= "<a class = 'active' href='AllDieuHoa.php?check=0&page="
                                    . $i . "'>" . $i . " </a>";
                            } else {
                                $pagLink .= "<a href='AllDieuHoa.php?check=0&page=" . $i . "'>   
                            " . $i . " </a>";
                            }
                        };
                        echo $pagLink;
                        ...
                        if ($page < $total_pages) {
                            echo "<a href='AllDieuHoa.php?check=0&page=" . ($page + 1) . "'>  Next </a>";
                        }
                    ...
                    <div class="pagination">
                        <?php
                        $queryy = "SELECT COUNT(*) FROM sanpham, hinhanh,danhmuc WHERE danhmuc.MaDanhMuc=SanPham.MaDanhMuc AND sanpham.MaSanPham=hinhanh.MaSanPham AND sanpham.MaDanhMuc='DM4' ;";
                        ...
                        if ($page >= 2) {
                            echo "<a href='AllDieuHoa.php?page=" . ($page - 1) . "'>  Prev </a>";
                        }

                        for ($i = 1; $i <= $total_pages; $i++) {
                            if ($i == $page) {
                                $pagLink .= "<a class = 'active' href='AllDieuHoa.php?page="
                                    . $i . "'>" . $i . " </a>";
                            } else {
                                $pagLink .= "<a href='AllDieuHoa.php?page=" . $i . "'>   
                            " . $i . " </a>";
                            }
                        };
                        echo $pagLink;
                        ...
                        if ($page < $total_pages) {
                            echo "<a href='AllDieuHoa.php?page=" . ($page + 1) . "'>  Next </a>";
                        }
...
<script>
    function go2Page1() {
        ...
        window.location.href = 'AllDieuHoa.php?check=0&page=' + page;
    }

    function go2Page() {
        var page = document.getElementById("page").value;
        page = ((page > <?php echo $total_pages; ?>) ? <?php echo $total_pages; ?> : ((page < 1) ? 1 : page));
        window.location.href = 'AllDieuHoa.php?&page=' + page;
    }
</script>