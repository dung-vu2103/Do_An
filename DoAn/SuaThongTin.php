        ...
        <main>
            ...
            <div style="margin-left:27vw;margin-top:20px">
                ...
                <table style="background-color: whitesmoke; width:620px;">
                    <form id="formquanlydanhmuc" action="Sua.php?hd=suakhfe&id=<?php echo $ds['MaKhachHang'] ?>" method="post" style="margin-top: -5vw; height: 25vw;">

                        <tr style="height:50px">
                            <td style="width:200px;padding-left:20px"><label for="tenkhachhang">Tên Khách Hàng:</label></td>
                            <td><input type="text" id="tenkhachhang" size="50" name="tenkhachhang" placeholder="<?php echo $ds['TenKhachHang'] ?>" required></td>
                        </tr>

                        <tr style="height:50px">
                            <td style="width:200px;padding-left:20px"><label for="sodienthoai">Số Điện Thoại : </label></td>
                            <td><input type="text" id="sodienthoai" size="50" name="sodienthoai" placeholder="<?php echo $ds['SoDienThoai'] ?>" required></td>
                        </tr>
                        <tr style="height:50px">
                            <td style="width:200px;padding-left:20px"><label for="email">Email:</label></td>
                            <td><input type="text" id="email" size="50" name="email" placeholder="<?php echo $ds['Email'] ?>" required></td>
                        </tr>
                        <tr style="height:50px">
                            <td style="width:200px;padding-left:20px"><label for="diachi">Địa Chỉ:</label></td>
                            <td><input type="text" id="diachi" size="50" name="diachi" placeholder="<?php echo $ds['DiaChi'] ?>" required></td>
                        </tr>
                        <tr style="height:50px">
                            <td style="width:200px;padding-left:20px"><label for="gioitinh">Giới Tính:</label></td>
                            <td>
                        ...
                        <tr style="height:50px">
                            <td style="width:200px;padding-left:20px"><label for="ngaysinh">Ngày Sinh:</label></td>
                        ...
                        <tr style="text-align: center;">
                            <td colspan="2"><button class="btn btn-primary" type="submit" name='sbm' style="margin-top: 1vw;color:aliceblue">Sửa</button></td>
                        </tr>
                    </form>
                </table>
            </div>
