...
<body>
  <header>
    <div class="logo">
      <ul>
        <li><a href="QuanLyHoaDon.php" style="font-size: 2vw;">Quản Lý Giỏ Hàng</a></li>
      </ul>
    ...
    <table style="text-align: center">
      <form>
        ...
        while ($dshoadon = $result->fetch_assoc()) { ?>
          <tr>
            <td>
              <?php echo $dshoadon['MaGioHang'] ?>
            </td>
            <td>
              <?php echo $dshoadon['MaKhachHang'] ?>
            </td>
            
            <td><a href="QuanLyHoaDonSua.php?id=<?php echo $dshoadon['MaGioHang'] ?>" <i class="fa fa-pencil" aria-hidden="true"></i></a></td>
            <td><a onclick="return Del()" href="Xoa.php?hd=xoahd&id=<?php echo $dshoadon['MaGioHang'] ?>" <i class="fa fa-trash" aria-hidden="true"></i></a></td>

          </tr>

        <?php } ?>
        <tr>
          <td><button type="button" style="margin-left: 8vw; margin-top: 12vw"><a href="QuanLyHoaDonThem.php" style="color:white;">Thêm</a></button></td>
