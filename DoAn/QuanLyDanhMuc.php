...
<body>
  <header>
    <div class="logo">
      <ul>
        <li><a href="QuanLyDanhMuc.php" style="font-size: 2vw;">Quản Lý Danh Mục</a></li>
      </ul>
  ...
  <main>
    <table style="text-align: center">
      ...
      while ($dsdanhmuc = $result->fetch_assoc()) { ?>
        <tr>
          <td>
            <?php echo $dsdanhmuc['MaDanhMuc'] ?>
          </td>
          <td>
            <?php echo $dsdanhmuc['TenDanhMuc'] ?>
          </td>

          <td><a href="SuaDanhMuc.php?hd=suadm&id=<?php echo $dsdanhmuc['MaDanhMuc'] ?>" <i class="fa fa-pencil" aria-hidden="true"></i></a></td>
          <td><a onclick="return Del()" href="Xoa.php?hd=xoadm&id=<?php echo $dsdanhmuc['MaDanhMuc'] ?>" <i class="fa fa-trash" aria-hidden="true"></i></a></td>
        </tr>

      <?php } ?>

      <tr>
        <td><button type="button" style="margin-left: 10vw; margin-top: 12vw"><a href="ThemDanhMuc.php" style="color:white;">Thêm</a></button></td>
