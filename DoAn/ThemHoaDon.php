...
<body>
    <header>
        <div class="logo">
            <ul>
                <li><a href="QuanLyDanhMuc.php" style="font-size: 2vw;">Thêm Hóa Đơn</a></li>
            </ul>
    ...
    <main>
        <table>
            <form id="formquanlynhacungcap" action="add.php?hd=themkh" method="post">
            <tr>
                    <td><label for="makhachhang">Mã Khách Hàng:</label></td>
                    <td><input type="text" id="makhachhang" size="50" name="makhachhang" required></td>
                </tr>
                <tr>
                    <td><label for="tenkhachhang">Tên Khách Hàng:</label></td>
                    <td><input type="text" id="tenkhachhang" size="50" name="tenkhachhang" required></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="email" size="50" name="email" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="taikhoan" size="50" name="taikhoan" required></td>
                </tr>
                <tr>
                    <td><label for="matkhau">Mật Khẩu:</label></td>
                    <td><input type="text" id="matkhau" size="50" name="matkhau" required></td>
                </tr>

                <tr>
                    <td colspan="2"><button type="submit" name='sbm' style="margin-top: 7vw;color:aliceblue">Thêm</button></td>
                </tr>
